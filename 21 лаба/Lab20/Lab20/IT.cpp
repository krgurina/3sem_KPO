...
namespace IT
{
	...
	//для создание любой переменной (параметров и обычных переменных)
	...
	//для перемонной integer со значением
	...
	//для перемонной string со значением
	...
	//для создание строки где её значение выраженное в виде литерала
	...
	//для повторно использующихся переменных
...
#pragma endregion
			* (idStream) << "\n\n\n";
			cout << "Таблица идентификаторов построена" << endl;
